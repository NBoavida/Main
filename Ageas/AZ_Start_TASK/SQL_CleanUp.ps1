...
New-AzureStorageContext -StorageAccountName ageasbackup -StorageAccountKey o5UnaTDZV34kzCMtFuvsqJ98+5s6RwiHH756V0Vy5OSKLjdaixLFh7xEx0NRMkv3oDqoc/8Z0KddrzrZ00hshQ== |  Get-AzureStorageBlob -Container sql | Where-Object {$_.LastModified  -lt "$LastWrite"} | Remove-AzureStorageBlob -Force
...
dir "k:\sql" | where {$_.LastWriteTime -le $now.AddDays(-5)} | del # -whatif
