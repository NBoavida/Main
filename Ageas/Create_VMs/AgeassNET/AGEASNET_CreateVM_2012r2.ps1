...
#>
#$OS = “a699494373c04fc0bc8f2bb1389d6106__Windows-Server-2012-R2-201412.01-en.us-127GB.vhd”
...
#CreateVM
New-AzureQuickVM -Windows -ServiceName $ServiceName -Name $name -InstanceSize Large -ImageName $OS  –ReservedIPName AGEASFE  -SubnetNames $SubnetNames -VNetName $VNetName
