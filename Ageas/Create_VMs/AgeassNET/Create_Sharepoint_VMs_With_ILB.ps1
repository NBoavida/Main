<#     
       ...
       Organization:     Agap2
        Filename: Create_Sharepoint_2_Vms_With_ILB
       ===========================================================================
       .DESCRIPTION
Salva uma imagem como template
#>
...
$vm1 = New-AzureVMConfig -ImageName "spazsp2013-02" -Name "SPAZSP2013-01" -InstanceSize Large |
...
$vm2 = New-AzureVMConfig -ImageName "spazsp2013-02" -Name "SPAZSP2013-02" -InstanceSize large |
        Add-AzureProvisioningConfig -Windows -AdminUsername adminazdoit -Password Locald0i7adm! | 
        Set-AzureSubnet -SubnetNames "Frontend" | 
