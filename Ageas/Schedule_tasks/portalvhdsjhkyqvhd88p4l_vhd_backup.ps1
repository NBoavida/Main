...
#region portalvhdsjhkyqvhd88p4l
# Destination Storage Account name 
$DestStorageAccountName = 'portalvhdsjhkyqvhd88p4l'

# Destination Storage Account Key 
$DestStorageAccountKey = '49iZpob6BWmEFMlKx2LSjKh5DqEfQjpaW5XaS6GkxqqDsp+N0cN9MU+K9T549QVfZevp+Tp9TeylGxDDoI/BLw=='
