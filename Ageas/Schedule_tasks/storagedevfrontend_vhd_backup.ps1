...
#region storagedevfrontend
# Destination Storage Account name 
$DestStorageAccountName = 'storagedevfrontend'

# Destination Storage Account Key 
$DestStorageAccountKey = 'fXlH8mzrSCf6zDwSuq2hfFp9lyXXynZ0/q+fBK9hI3fh/a0dwNwGM78zb0ECaWWRQRehjaO+UrqIe8I3ZnMaCQ=='
