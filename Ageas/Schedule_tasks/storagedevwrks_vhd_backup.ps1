...
#region storagedevwrks
# Destination Storage Account name 
$DestStorageAccountName = 'storagedevwrks'

# Destination Storage Account Key 
$DestStorageAccountKey = 'QYE1vObm6uApnSZ82qvqy/zMPyywXzKT7Mlr5wSHv5m25wat/KMArULYTLDa2rgYSEoPB1LZXZfIqAu9akM6zA=='
