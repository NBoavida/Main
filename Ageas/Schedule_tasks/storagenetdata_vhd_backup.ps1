...
#region storagenetdata
# Destination Storage Account name 
$DestStorageAccountName = 'storagenetdata'

# Destination Storage Account Key 
$DestStorageAccountKey = 'IBcHNKCGNGO/NrSLyvUdOwNZPDI1KbGhR/GIGM8ZgtrXW6E/qcnWzPd0iRfF18fjLMhMyzAh2DzyvQt3woYLBg=='
