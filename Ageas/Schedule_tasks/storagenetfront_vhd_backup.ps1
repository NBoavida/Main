...
#region storagenetfront
# Destination Storage Account name 
$DestStorageAccountName = 'storagenetfront'

# Destination Storage Account Key 
$DestStorageAccountKey = '/JjLsJme2kTZuRblmsu4utc1nQfBmCWMaOddk32YpkLhGU5iCc6OBUhHXF9w98axqxC1PuHexwU4NlOLHtj4Dw=='
