...
#region Var
#var
    $scopetxt = "d:\ff\dhcp\migtool\scopes.txt" #txt com as scopes a migrar
    $dhcpexportxml = "d:\ff\dhcp\migtool\dhcp01.xml" #export dhcp1
    $dhcpexportxml2 = "d:\ff\dhcp\migtool\dhcp02.xml" #Export dhcp2
    $scopeid = gc  $scopetxt #ler as scopes a migrar
    $NOVODHCPXML = "d:\ff\dhcp\migtool\dhcp03.xml" #merge xml
...
if ($choice -eq "y"){
            ...
            $dhcp01xml.DHCPServer.IPv4.Scopes.Scope.AppendChild( $dhcp01xml.ImportNode(($dhcp02xml.DHCPServer.IPv4.Scopes.Scope.Leases) , $true))
